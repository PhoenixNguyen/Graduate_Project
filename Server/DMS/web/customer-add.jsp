				...
				<table border=0 cellspacing=0 cellpadding=3 width=100% class="small">
				   <tr>
					<td class="dvtTabCache" style="width:10px" nowrap>&nbsp;</td>
						...
						<td width=75 style="width:15%" align="center" nowrap class="dvtSelectedCell" id="bi" onclick="fnLoadValues('bi','mi','basicTab','moreTab','normal','Accounts')"><b>Cơ bản Thông tin</b></td>
								...
								<table border=0 cellspacing=0 cellpadding=0 width="100%" class="small">
								   <tr>
									<td  colspan=4 style="padding:5px">
									   <div align="center">
																					<input title="Lưu [Alt+S]" accessKey="S" class="crmbutton small save" onclick="this.form.action.value='Save';  if(formValidate())AjaxDuplicateValidate('Accounts','accountname',this.form);" type="button" name="button" value="  Lưu  " style="width:70px" >
...
<!-- Added this file to display the fields in Create Entity page based on ui types  -->
			...
			<td width=30% align=left class="dvtCellInfo">
				...
				<td width=20% class="dvtCellLabel" align=right><font color="red"></font>Mã số Khách hàng </td>
                                <td width=30% align=left class="dvtCellInfo"><input readonly type="text" tabindex="" name="account_no" id ="account_no"  value="AUTO GEN ON SAVE"  class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'"></td>
			   </tr>
			<tr style="height:25px">
			...
			<tr style="height:25px">
					...
					<span id="vtbusy_info" style="display:none;">
						<img src="themes/images/vtbusy.gif" border="0"></span>
							...
							<td width=30% align=left class="dvtCellInfo"><input type="text" tabindex="" name="fax" id ="fax" value="" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'"></td>
						   </tr>
			<tr style="height:25px">
