                                        ...
                                        <tbody><tr>
                                            ...
                                            <tr>
                                                <td align="right" style="padding-right:40px;" class="reportCreateBottom">
                                                    <input type="submit" name="button" value=" &nbsp;‹ Quay lại &nbsp; " class="crmbutton small cancel" onclick="this.form.action.value = 'Import';
                                                            this.form.step.value = '1';
                                                            return true;">
                                                    &nbsp;&nbsp;
                                                    <input type="button" name="button" value=" &nbsp; Nhập dữ liệu › &nbsp; " class="crmbutton small save" onclick="this.form.action.value = 'Import';
                                                            this.form.step.value = '3';
                                                            check_submit();">
                                                </td>
                                            </tr>
                                        </tbody></table>
