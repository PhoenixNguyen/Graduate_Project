...
<div class="drop_mnu" id="Tools_sub" onmouseout="fnHideDrop('Tools_sub')" onmouseover="fnShowDrop('Tools_sub')" style="left: 564px; top: 75px; display: none;">
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
...
<div class="drop_mnu" id="Settings_sub" onmouseout="fnHideDrop('Settings_sub')" onmouseover="fnShowDrop('Settings_sub')" style="left: 644px; top: 75px; display: none;">
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
...
<script language="JavaScript" type="text/javascript" src="modules/Vendors/Vendors.js"></script><script type="text/javascript" src="include/js/Mail.js"></script><script type="text/javascript" src="include/js/Merge.js"></script>
...
function callSearch(searchtype)
{
	...
	new Ajax.Request(
		...
		{queue: {position: 'end', scope: 'command'},
			method: 'post',
			postBody:urlstring +'query=true&file=index&module=Vendors&action=VendorsAjax&ajax=true&search=true',
			onComplete: function(response) {
								$("status").style.display="none";
	...
	<td width="100%" nowrap="">
		...
		<td class="small">
			...
			<td>
				...
				<tbody><tr>
											 ...
											 <td style="padding-right:10px"><a href="javascript:;" onclick="moveMe('searchAcc');searchshowhide('searchAcc','advSearch');mergehide('mergeDup')"><img src="themes/softed/images/btnL3Search.gif" alt="Tìm kiếm trong Nhà cung cấp..." title="Tìm kiếm trong Nhà cung cấp..." border="0"></a></td>
		...
		<td class="small">
			...
			<tbody><tr>
					...
					<!--<td style="padding-right:10px"><a href="index.php?module=Vendors&action=FindDuplicateRecords&button_view=true&list_view=true&parenttab=Inventory"><img src="themes/softed/images/findduplicates.gif" alt="" title="Tìm kiếm trùng" border="0"></a></td> -->
	...
	<tbody><tr>
		...
		<td class="small" nowrap="">
			...
			<select name="search_field" id="bas_searchfield" class="txtBox" style="width:150px">
			 <option label="Số Nhà cung cấp" value="vendor_no">Số Nhà cung cấp</option>
...
<option label="Loại" value="category">Loại</option>
	...
	<tr>
		<td colspan="7" align="center" class="small">
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tbody><tr>
                                                <td class="searchAlph" id="alpha_1" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=A&quot;,&quot;alpha_1&quot;)">A</td><td class="searchAlph" id="alpha_2" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=B&quot;,&quot;alpha_2&quot;)">B</td><td class="searchAlph" id="alpha_3" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=C&quot;,&quot;alpha_3&quot;)">C</td><td class="searchAlph" id="alpha_4" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=D&quot;,&quot;alpha_4&quot;)">D</td><td class="searchAlph" id="alpha_5" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=E&quot;,&quot;alpha_5&quot;)">E</td><td class="searchAlph" id="alpha_6" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=F&quot;,&quot;alpha_6&quot;)">F</td><td class="searchAlph" id="alpha_7" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=G&quot;,&quot;alpha_7&quot;)">G</td><td class="searchAlph" id="alpha_8" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=H&quot;,&quot;alpha_8&quot;)">H</td><td class="searchAlph" id="alpha_9" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=I&quot;,&quot;alpha_9&quot;)">I</td><td class="searchAlph" id="alpha_10" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=J&quot;,&quot;alpha_10&quot;)">J</td><td class="searchAlph" id="alpha_11" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=K&quot;,&quot;alpha_11&quot;)">K</td><td class="searchAlph" id="alpha_12" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=L&quot;,&quot;alpha_12&quot;)">L</td><td class="searchAlph" id="alpha_13" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=M&quot;,&quot;alpha_13&quot;)">M</td><td class="searchAlph" id="alpha_14" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=N&quot;,&quot;alpha_14&quot;)">N</td><td class="searchAlph" id="alpha_15" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=O&quot;,&quot;alpha_15&quot;)">O</td><td class="searchAlph" id="alpha_16" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=P&quot;,&quot;alpha_16&quot;)">P</td><td class="searchAlph" id="alpha_17" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=Q&quot;,&quot;alpha_17&quot;)">Q</td><td class="searchAlph" id="alpha_18" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=R&quot;,&quot;alpha_18&quot;)">R</td><td class="searchAlph" id="alpha_19" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=S&quot;,&quot;alpha_19&quot;)">S</td><td class="searchAlph" id="alpha_20" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=T&quot;,&quot;alpha_20&quot;)">T</td><td class="searchAlph" id="alpha_21" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=U&quot;,&quot;alpha_21&quot;)">U</td><td class="searchAlph" id="alpha_22" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=V&quot;,&quot;alpha_22&quot;)">V</td><td class="searchAlph" id="alpha_23" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=W&quot;,&quot;alpha_23&quot;)">W</td><td class="searchAlph" id="alpha_24" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=X&quot;,&quot;alpha_24&quot;)">X</td><td class="searchAlph" id="alpha_25" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=Y&quot;,&quot;alpha_25&quot;)">Y</td><td class="searchAlph" id="alpha_26" align="center" onclick="alphabetic(&quot;Vendors&quot;,&quot;gname=&amp;query=true&amp;search_field=vendorname&amp;searchtype=BasicSearch&amp;operator=s&amp;type=alpbt&amp;search_text=Z&quot;,&quot;alpha_26&quot;)">Z</td>
                                </tr>
                        </tbody></table>
		</td>
	</tr>
			...
			<tbody><tr>
				...
				<div id="fixed" style="position:relative;width:95%;height:80px;padding:0px; overflow:auto;border:1px solid #CCCCCC;background-color:#ffffff" class="small">
					...
					<td align="left">
						...
						<tbody><tr>
							<td width="31%"><select name="Fields0" id="Fields0" class="detailedViewTextBox" onchange="updatefOptions(this, 'Condition0')"><optgroup label="Mô tả" class="select" style="border:none"><option value="\'description::::V\'">Mô tả</option></optgroup><optgroup label="Thông tin Nhà cung cấp" class="select" style="border:none"><option value="\'modifiedtime::::T\'">Cập nhật lúc</option><option value="\'email::::E\'">Email</option><option value="\'category::::V\'">Loại</option><option value="\'vendor_no::::V\'">Số Nhà cung cấp</option><option value="\'glacct::::V\'">Tài khoản Kế toán</option><option value="\'vendorname::::V\'" selected="">Tên Nhà cung cấp</option><option value="\'createdtime::::T\'">Tạo lúc</option><option value="\'website::::V\'">Website</option><option value="\'phone::::V\'">Điện thoại</option></optgroup><optgroup label="Thông tin địa chỉ" class="select" style="border:none"><option value="\'pobox::::V\'">Hộp thư</option><option value="\'postalcode::::V\'">Mã vùng</option><option value="\'country::::V\'">Quốc gia</option><option value="\'city::::V\'">Thành phố</option><option value="\'state::::V\'">Tỉnh/Bang</option><option value="\'street::::V\'">Địa chỉ</option></optgroup></select>
							</td>
...
<form enctype="multipart/form-data" name="mergeDuplicates" method="post" action="index.php?module=Vendors&amp;action=FindDuplicateRecords" onsubmit="VtigerJS_DialogBox.block();">
	<input type="hidden" name="module" value="Vendors">
	<input type="hidden" name="parenttab" value="Inventory">
			   ...
			   <tr><td colspan="3"></td></tr>
				...
				<tr>
					<td width="47%">
						...
						<option value="276">Tên Nhà cung cấp</option><option value="278">Điện thoại</option><option value="279">Email</option><option value="280">Website</option><option value="281">Tài khoản Kế toán</option><option value="282">Loại</option><option value="285">Địa chỉ</option><option value="286">Hộp thư</option><option value="287">Thành phố</option><option value="288">Tỉnh/Bang</option><option value="289">Mã vùng</option><option value="290">Quốc gia</option><option value="291">Mô tả</option>
						</select>
					</td>
					<td width="6%">
						<div align="center">
...
<form name="massdelete" method="POST" id="massdelete" onsubmit="VtigerJS_DialogBox.block();">
     ...
     <input name="current_page_boxes" id="current_page_boxes" type="hidden" value="7121;4123;7568;2277;141;7921;9361;2276;10217">
				...
				<td style="padding-right:20px" nowrap="">
                                                              ...
                                                              <input class="crmbutton small delete" type="button" value="Xóa" onclick="return massDelete('Vendors')">
                                                                                 <input class="crmbutton small edit" type="button" value="Sửa nhanh" onclick="return mass_edit(this, 'massedit', 'Vendors', 'Inventory')">
                                                    
                								
															
                </td>
				<td class="small" nowrap="">
					Hiển thị Bản ghi 1 - 9 trên 9
				</td>
				<!-- Page Navigation -->
				<td nowrap="" width="30%" align="center">
					<table border="0" cellspacing="0" cellpadding="0" class="small">
						<tbody><tr><td align="right" style="padding: 5px;"><img src="themes/images/start_disabled.gif" border="0" align="absmiddle">&nbsp;<img src="themes/images/previous_disabled.gif" border="0" align="absmiddle">&nbsp;<input class="small" name="pagenum" type="text" value="1" style="width: 3em;margin-right: 0.7em;" onchange="getListViewEntries_js('Vendors','parenttab=Inventory&amp;start='+this.value+'');" onkeypress="return VT_disableFormSubmit(event);"><span name="Vendors_listViewCountContainerName" class="small" style="white-space: nowrap;">trên 1</span><img src="themes/images/next_disabled.gif" border="0" align="absmiddle">&nbsp;<img src="themes/images/end_disabled.gif" border="0" align="absmiddle">&nbsp;</td></tr>
					</tbody></table>
                </td>
				   ...
				   <!-- Filters -->
					...
					<tbody><tr>
						...
						<td style="padding-left:5px;padding-right:5px">
                            <select name="viewname" id="viewname" class="small" onchange="showDefaultCustomView(this,'Vendors','Inventory')"><option selected="" value="27">Tất cả</option></select></td>
                            							<td><a href="index.php?module=Vendors&amp;action=CustomView&amp;parenttab=Inventory">Mới</a>
            ...
            <td class="lvtCol"><input type="checkbox" name="selectall" onclick="toggleSelect_ListView(this.checked,&quot;selected_id&quot;)"></td>
				  			<td class="lvtCol"><a href="javascript:;" onclick="getListViewEntries_js(&quot;Vendors&quot;,&quot;parenttab=Inventory&amp;foldername=Default&amp;order_by=vendor_no&amp;start=1&amp;sorder=ASC&amp;viewname=27&quot;);" class="listFormHeaderLinks">Số Nhà cung cấp</a></td>
				 			<td class="lvtCol"><a href="javascript:;" onclick="getListViewEntries_js(&quot;Vendors&quot;,&quot;parenttab=Inventory&amp;foldername=Default&amp;order_by=vendorname&amp;start=1&amp;sorder=DESC&amp;viewname=27&quot;);" class="listFormHeaderLinks">Tên Nhà cung cấp&nbsp;<img src="themes/images/arrow_down.gif" border="0"></a></td>
				 			<td class="lvtCol"><a href="javascript:;" onclick="getListViewEntries_js(&quot;Vendors&quot;,&quot;parenttab=Inventory&amp;foldername=Default&amp;order_by=phone&amp;start=1&amp;sorder=ASC&amp;viewname=27&quot;);" class="listFormHeaderLinks">Điện thoại</a></td>
				 			<td class="lvtCol"><a href="javascript:;" onclick="getListViewEntries_js(&quot;Vendors&quot;,&quot;parenttab=Inventory&amp;foldername=Default&amp;order_by=email&amp;start=1&amp;sorder=ASC&amp;viewname=27&quot;);" class="listFormHeaderLinks">Email</a></td>
				 			<td class="lvtCol"><a href="javascript:;" onclick="getListViewEntries_js(&quot;Vendors&quot;,&quot;parenttab=Inventory&amp;foldername=Default&amp;order_by=category&amp;start=1&amp;sorder=ASC&amp;viewname=27&quot;);" class="listFormHeaderLinks">Loại</a></td>
			...
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;action=EditView&amp;record=7121&amp;return_module=Vendors&amp;return_action=index&amp;parenttab=Inventory&amp;return_viewname=27">Sửa</a>  | <a href='javascript:confirmdelete("index.php%3Fmodule%3DVendors%26action%3DDelete%26record%3D7121%26return_module%3DVendors%26return_action%3Dindex%26parenttab%3DInventory%26return_viewname%3D27")'>Xóa</a></td>
						...
						<tr bgcolor="white" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'" id="row_4123" class="lvtColData">
			<td width="2%"><input type="checkbox" name="selected_id" id="4123" value="4123" onclick="check_object(this)"></td>
							
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">VEN14 <span type="vtlib_metainfo" vtrecordid="4123" vtfieldname="vendor_no" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;parenttab=Inventory&amp;action=DetailView&amp;record=4123" title="Vendors">Chị Thư - FSViet</a> <span type="vtlib_metainfo" vtrecordid="4123" vtfieldname="vendorname" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"> <span type="vtlib_metainfo" vtrecordid="4123" vtfieldname="phone" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="javascript:InternalMailer(4123,279,'email','Vendors','record_id');">thudta@fsviet.com</a> <span type="vtlib_metainfo" vtrecordid="4123" vtfieldname="email" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"> <span type="vtlib_metainfo" vtrecordid="4123" vtfieldname="category" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;action=EditView&amp;record=4123&amp;return_module=Vendors&amp;return_action=index&amp;parenttab=Inventory&amp;return_viewname=27">Sửa</a>  | <a href='javascript:confirmdelete("index.php%3Fmodule%3DVendors%26action%3DDelete%26record%3D4123%26return_module%3DVendors%26return_action%3Dindex%26parenttab%3DInventory%26return_viewname%3D27")'>Xóa</a></td>
				        			</tr>
						<tr bgcolor="white" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'" id="row_7568">
			<td width="2%"><input type="checkbox" name="selected_id" id="7568" value="7568" onclick="check_object(this)"></td>
							
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">VEN16 <span type="vtlib_metainfo" vtrecordid="7568" vtfieldname="vendor_no" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;parenttab=Inventory&amp;action=DetailView&amp;record=7568" title="Vendors">chuyển fax nhanh</a> <span type="vtlib_metainfo" vtrecordid="7568" vtfieldname="vendorname" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">anh dung t2-6: 094 707 1982 <span type="vtlib_metainfo" vtrecordid="7568" vtfieldname="phone" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="javascript:InternalMailer(7568,279,'email','Vendors','record_id');"></a> <span type="vtlib_metainfo" vtrecordid="7568" vtfieldname="email" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">goi thu 7: 0163996515 <span type="vtlib_metainfo" vtrecordid="7568" vtfieldname="category" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;action=EditView&amp;record=7568&amp;return_module=Vendors&amp;return_action=index&amp;parenttab=Inventory&amp;return_viewname=27">Sửa</a>  | <a href='javascript:confirmdelete("index.php%3Fmodule%3DVendors%26action%3DDelete%26record%3D7568%26return_module%3DVendors%26return_action%3Dindex%26parenttab%3DInventory%26return_viewname%3D27")'>Xóa</a></td>
				        			</tr>
						<tr bgcolor="white" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'" id="row_2277">
			<td width="2%"><input type="checkbox" name="selected_id" id="2277" value="2277" onclick="check_object(this)"></td>
							
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">VEN13 <span type="vtlib_metainfo" vtrecordid="2277" vtfieldname="vendor_no" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;parenttab=Inventory&amp;action=DetailView&amp;record=2277" title="Vendors">Công ty AutoID</a> <span type="vtlib_metainfo" vtrecordid="2277" vtfieldname="vendorname" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">0987144786- c HƯƠNG <span type="vtlib_metainfo" vtrecordid="2277" vtfieldname="phone" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="javascript:InternalMailer(2277,279,'email','Vendors','record_id');"></a> <span type="vtlib_metainfo" vtrecordid="2277" vtfieldname="email" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"> <span type="vtlib_metainfo" vtrecordid="2277" vtfieldname="category" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;action=EditView&amp;record=2277&amp;return_module=Vendors&amp;return_action=index&amp;parenttab=Inventory&amp;return_viewname=27">Sửa</a>  | <a href='javascript:confirmdelete("index.php%3Fmodule%3DVendors%26action%3DDelete%26record%3D2277%26return_module%3DVendors%26return_action%3Dindex%26parenttab%3DInventory%26return_viewname%3D27")'>Xóa</a></td>
				        			</tr>
						<tr bgcolor="white" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'" id="row_141">
			<td width="2%"><input type="checkbox" name="selected_id" id="141" value="141" onclick="check_object(this)"></td>
							
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">VEN11 <span type="vtlib_metainfo" vtrecordid="141" vtfieldname="vendor_no" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;parenttab=Inventory&amp;action=DetailView&amp;record=141" title="Vendors">Công ty phần mềm HOSCO</a> <span type="vtlib_metainfo" vtrecordid="141" vtfieldname="vendorname" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">0466839286 <span type="vtlib_metainfo" vtrecordid="141" vtfieldname="phone" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="javascript:InternalMailer(141,279,'email','Vendors','record_id');">contact@hosgroup.com.vn</a> <span type="vtlib_metainfo" vtrecordid="141" vtfieldname="email" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"> <span type="vtlib_metainfo" vtrecordid="141" vtfieldname="category" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;action=EditView&amp;record=141&amp;return_module=Vendors&amp;return_action=index&amp;parenttab=Inventory&amp;return_viewname=27">Sửa</a>  | <a href='javascript:confirmdelete("index.php%3Fmodule%3DVendors%26action%3DDelete%26record%3D141%26return_module%3DVendors%26return_action%3Dindex%26parenttab%3DInventory%26return_viewname%3D27")'>Xóa</a></td>
				        			</tr>
						<tr bgcolor="white" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'" id="row_7921">
			<td width="2%"><input type="checkbox" name="selected_id" id="7921" value="7921" onclick="check_object(this)"></td>
							
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">VEN17 <span type="vtlib_metainfo" vtrecordid="7921" vtfieldname="vendor_no" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;parenttab=Inventory&amp;action=DetailView&amp;record=7921" title="Vendors">gọi Gạo nước</a> <span type="vtlib_metainfo" vtrecordid="7921" vtfieldname="vendorname" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">0916143246 <span type="vtlib_metainfo" vtrecordid="7921" vtfieldname="phone" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="javascript:InternalMailer(7921,279,'email','Vendors','record_id');"></a> <span type="vtlib_metainfo" vtrecordid="7921" vtfieldname="email" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"> <span type="vtlib_metainfo" vtrecordid="7921" vtfieldname="category" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;action=EditView&amp;record=7921&amp;return_module=Vendors&amp;return_action=index&amp;parenttab=Inventory&amp;return_viewname=27">Sửa</a>  | <a href='javascript:confirmdelete("index.php%3Fmodule%3DVendors%26action%3DDelete%26record%3D7921%26return_module%3DVendors%26return_action%3Dindex%26parenttab%3DInventory%26return_viewname%3D27")'>Xóa</a></td>
				        			</tr>
						<tr bgcolor="white" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'" id="row_9361">
			<td width="2%"><input type="checkbox" name="selected_id" id="9361" value="9361" onclick="check_object(this)"></td>
							
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">VEN18 <span type="vtlib_metainfo" vtrecordid="9361" vtfieldname="vendor_no" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;parenttab=Inventory&amp;action=DetailView&amp;record=9361" title="Vendors">Máy tính Đại Việt</a> <span type="vtlib_metainfo" vtrecordid="9361" vtfieldname="vendorname" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">04.66823.191 – 0986.081.821 <span type="vtlib_metainfo" vtrecordid="9361" vtfieldname="phone" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="javascript:InternalMailer(9361,279,'email','Vendors','record_id');"></a> <span type="vtlib_metainfo" vtrecordid="9361" vtfieldname="email" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"> <span type="vtlib_metainfo" vtrecordid="9361" vtfieldname="category" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;action=EditView&amp;record=9361&amp;return_module=Vendors&amp;return_action=index&amp;parenttab=Inventory&amp;return_viewname=27">Sửa</a>  | <a href='javascript:confirmdelete("index.php%3Fmodule%3DVendors%26action%3DDelete%26record%3D9361%26return_module%3DVendors%26return_action%3Dindex%26parenttab%3DInventory%26return_viewname%3D27")'>Xóa</a></td>
				        			</tr>
						<tr bgcolor="white" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'" id="row_2276">
			<td width="2%"><input type="checkbox" name="selected_id" id="2276" value="2276" onclick="check_object(this)"></td>
							
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">VEN12 <span type="vtlib_metainfo" vtrecordid="2276" vtfieldname="vendor_no" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;parenttab=Inventory&amp;action=DetailView&amp;record=2276" title="Vendors">Máy tính Việt Á</a> <span type="vtlib_metainfo" vtrecordid="2276" vtfieldname="vendorname" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">04. 66.711.441 - Hotline: 0974.222.114 <span type="vtlib_metainfo" vtrecordid="2276" vtfieldname="phone" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="javascript:InternalMailer(2276,279,'email','Vendors','record_id');">Mr.thelinh@gmail.com</a> <span type="vtlib_metainfo" vtrecordid="2276" vtfieldname="email" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">Mực in <span type="vtlib_metainfo" vtrecordid="2276" vtfieldname="category" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;action=EditView&amp;record=2276&amp;return_module=Vendors&amp;return_action=index&amp;parenttab=Inventory&amp;return_viewname=27">Sửa</a>  | <a href='javascript:confirmdelete("index.php%3Fmodule%3DVendors%26action%3DDelete%26record%3D2276%26return_module%3DVendors%26return_action%3Dindex%26parenttab%3DInventory%26return_viewname%3D27")'>Xóa</a></td>
				        			</tr>
						<tr bgcolor="white" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'" id="row_10217">
			<td width="2%"><input type="checkbox" name="selected_id" id="10217" value="10217" onclick="check_object(this)"></td>
							
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">VEN19 <span type="vtlib_metainfo" vtrecordid="10217" vtfieldname="vendor_no" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;parenttab=Inventory&amp;action=DetailView&amp;record=10217" title="Vendors">VietNam work</a> <span type="vtlib_metainfo" vtrecordid="10217" vtfieldname="vendorname" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))">(84 4) 39388768 <span type="vtlib_metainfo" vtrecordid="10217" vtfieldname="phone" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="javascript:InternalMailer(10217,279,'email','Vendors','record_id');">Phuong.Kim.Do@vietnamworks.com</a> <span type="vtlib_metainfo" vtrecordid="10217" vtfieldname="email" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"> <span type="vtlib_metainfo" vtrecordid="10217" vtfieldname="category" vtmodule="Vendors" style="display:none;"></span></td>
				        				
			<td onmouseover="vtlib_listview.trigger('cell.onmouseover', $(this))" onmouseout="vtlib_listview.trigger('cell.onmouseout', $(this))"><a href="index.php?module=Vendors&amp;action=EditView&amp;record=10217&amp;return_module=Vendors&amp;return_action=index&amp;parenttab=Inventory&amp;return_viewname=27">Sửa</a>  | <a href='javascript:confirmdelete("index.php%3Fmodule%3DVendors%26action%3DDelete%26record%3D10217%26return_module%3DVendors%26return_action%3Dindex%26parenttab%3DInventory%26return_viewname%3D27")'>Xóa</a></td>
				        			</tr>
						 </tbody></table>
			 </div>
			 ...
			 <table border="0" cellspacing="0" cellpadding="2" width="100%">
				 ...
				 <td style="padding-right:20px" nowrap="">
                                                                                                                     <input class="crmbutton small delete" type="button" value="Xóa" onclick="return massDelete('Vendors')">
					                                                                                             					                         <input class="crmbutton small edit" type="button" value="Sửa nhanh" onclick="return mass_edit(this, 'massedit', 'Vendors')">
