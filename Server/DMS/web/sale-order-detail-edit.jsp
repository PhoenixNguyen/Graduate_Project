...
//                                                                                                return validateInventory('SalesOrder')
                                                                                        ...
                                                                                        <tr style="height:25px">
                                                                                            ...
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input type="text" tabindex="" name="saleOrderDetail.discount" id="salescommission" value="<s:property value="saleOrderDetail.discount"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'">
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr style="height:25px">
                                                                                        ...
                                                                                        <tr style="height:25px">
                                                                                            ...
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input type="text"  tabindex="" name="saleOrderDetail.number" id="salescommission" value="<s:property value="saleOrderDetail.number"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'">
                                                                                            </td>
            ...
            <!--                                                                                <td class="dvtCellInfo" align="left" width="25%&quot;">&nbsp;<s:property value="takeOrder.getOrderEstablishDate()"/></td>-->
                                                                                        ...
                                                                                        <tr style="height:25px">
                                                                                            ...
                                                                                            <!-- This file is used to display the fields based on the ui type in detailview -->
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input type="text"  tabindex="" name="saleOrderDetail.promotionalProductMount" id="salescommission" value="<s:property value="saleOrderDetail.promotionalProductMount"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'">
                                                                                            </td>
