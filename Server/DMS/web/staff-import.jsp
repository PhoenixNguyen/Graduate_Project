...
<html>
    ...
    <body leftmargin="0" topmargin="0" marginheight="0" marginwidth="0" class="small">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="hdrNameBg">
            ...
            <marquee id="rss" direction="left" scrolldelay="10" scrollamount="3" behavior="scroll" class="marStyle" onmouseover="javascript:stop();" onmouseout="javascript:start();">&nbsp;admin : </marquee>
